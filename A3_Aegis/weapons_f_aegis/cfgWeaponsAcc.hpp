class srifle_EBR_blk_DMS_LP_BI_S_F: srifle_EBR_blk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_DMS);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_B);
...
class srifle_EBR_khk_DMS_LP_BI_S_F: srifle_EBR_khk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_DMS);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_B_khk_F);
...
class srifle_DMR_02_sniper_AMS_LP_S_F: srifle_DMR_02_sniper_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_AMS_snd);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_338_sand);
        LINKED_UNDERBARREL(bipod_01_F_snd);
	};
};
...
class srifle_DMR_02_AMS_LP_BI_S_F: srifle_DMR_02_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_AMS);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_338_black);
        LINKED_UNDERBARREL(bipod_01_F_blk);
	};
};
...
class LMG_Mk200_khk_Hamr_Pointer_Bipod_Snds_F: LMG_Mk200_khk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Hamr_khk_F);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_H_khk_F);
        LINKED_UNDERBARREL(bipod_01_F_khk);
	};
};
...
class hgun_Pistol_heavy_01_black_MRD_F: hgun_Pistol_heavy_01_black_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_MRD_black);
	};
};
class arifle_Katiba_C_ACO_flash_F: arifle_Katiba_C_F
{
	class LinkedItems
	{
...
class arifle_Katiba_C_ARCO_pointer_snds_F: arifle_Katiba_C_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Arco_blk_F);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_65_TI_blk_F);
	};
};
class arifle_Katiba_GL_ARCO_pointer_snds_F: arifle_Katiba_GL_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Arco_blk_F);
...
class arifle_Mk20C_ACO_flash_F: arifle_Mk20C_F
{
	class LinkedItems
	{
...
class arifle_MXC_Black_Holo_Pointer_Snds_F: arifle_MXC_Black_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Holosight_blk_F);
        LINKED_SIDE(acc_pointer_IR);
...
class arifle_CTAR_GL_blk_ARCO_Pointer_Snds_F: arifle_CTAR_GL_blk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Arco_blk_F);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_58_blk_F);
	};
};
...
class arifle_SPAR_01_khk_RCO_Pointer_Snds_F: arifle_SPAR_01_khk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Hamr_khk_F);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_M_khk_F);
	};
};
...
class arifle_SPAR_01_snd_RCO_Pointer_Snds_F: arifle_SPAR_01_snd_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Hamr);
        LINKED_SIDE(acc_pointer_IR);
        LINKED_MUZZLE(muzzle_snds_M_snd_F);
	};
};
...
class arifle_MSBS65_aco_FL_F: arifle_MSBS65_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_ACO);
...
class arifle_MSBS65_snds_ico_pointer_F: arifle_MSBS65_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_ico_01_f);
        LINKED_SIDE(acc_flashlight);
        LINKED_MUZZLE(muzzle_snds_H);
	};
};
...
class SMG_01_black_Holo_F: SMG_01_black_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Holosight_smg_blk_F);
	};
};
class SMG_01_khk_Holo_F: SMG_01_khk_F
{
	class LinkedItems
	{
        LINKED_TOP(optic_Holosight_smg_khk_F);
	};
};
