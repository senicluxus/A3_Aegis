...
class B_ION_UAV_06_F: UAV_06_base_F
{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {B_ION_UAV_06_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3_Aegis\Air_F_Aegis\UAV_06\Data\B_ION_UAV_06_CO.paa"};
};
class B_ION_UAV_06_medical_F: UAV_06_medical_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {B_ION_UAV_06_medical_backpack_F};
	};
...
class Box_B_ION_UAV_06_F: Box_UAV_06_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
...
class Box_B_ION_UAV_06_medical_F: Box_UAV_06_medical_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
...
class B_ION_UAV_06_backpack_F: UAV_06_backpack_base_F
{
	...
	hiddenSelectionsTextures[] =
	{
		"\A3_Aegis\Supplies_F_Aegis\Bags\Data\UAV_backpack_ION_CO.paa",
		"\A3_Aegis\Air_F_Aegis\UAV_06\Data\B_ION_UAV_06_CO.paa"
	};
	class assembleInfo: assembleInfo
	{
		displayName = $STR_A3_A_CfgVehicles_B_ION_UAV_06_backpack_F_assembleInfo0;
		assembleTo = B_ION_UAV_06_F;
	};
};
class B_ION_UAV_06_medical_backpack_F: UAV_06_medical_backpack_base_F
{
	...
	class assembleInfo: assembleInfo
	{
		displayName = $STR_A3_A_CfgVehicles_B_ION_UAV_06_medical_backpack_F_assembleInfo0;
		assembleTo = B_ION_UAV_06_medical_F;
	};
};