/* Russia */
class I_Raven_UAV_06_F: UAV_06_base_F
{
...
class I_Raven_UAV_06_medical_F: UAV_06_medical_base_F
{
	author = $STR_A3_A_Heliotrope;
	class SimpleObject
	{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {I_Raven_UAV_06_medical_backpack_F};
	};
...
class Box_I_Raven_UAV_06_F: Box_UAV_06_base_F
{
	author = $STR_A3_A_Heliotrope;
	class SimpleObject
	{
...
class Box_I_Raven_UAV_06_medical_F: Box_UAV_06_medical_base_F
{
	author = $STR_A3_A_Heliotrope;
	class SimpleObject
	{
...
class I_Raven_UAV_06_backpack_F: UAV_06_backpack_base_F
{
	author = $STR_A3_A_Heliotrope;
	scope = public;
	scopeCurator = public;
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = I_Raven_UAV_06_F;
	};
};
class I_Raven_UAV_06_medical_backpack_F: UAV_06_medical_backpack_base_F
{
	author = $STR_A3_A_Heliotrope;
	scope = public;
	scopeCurator = public;
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = I_Raven_UAV_06_medical_F;
	};
};
