...
class I_Raven_UAV_01_F: UAV_01_base_F
{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {I_Raven_UAV_01_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3_Aegis\Air_F_Aegis\UAV_01\Data\UAV_01_RUgrey_CO.paa"};
	textureList[] = {Rus,1};
};
class I_Raven_UAV_01_backpack_F: Weapon_Bag_Base
{
	author = $STR_A3_A_Heliotrope;
	mapSize = 0.6;
	scope = public;
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = I_Raven_UAV_01_F;
	};
};

/* Raven Security - OPFOR */
class O_Raven_UAV_01_F: UAV_01_base_F
{
	author = $STR_A3_A_Heliotrope;
	class SimpleObject
	{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {O_Raven_UAV_01_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3_Aegis\Air_F_Aegis\UAV_01\Data\UAV_01_RUgrey_CO.paa"};
	textureList[] = {Rus,1};
};
class O_Raven_UAV_01_backpack_F: Weapon_Bag_Base
{
	author = $STR_A3_A_Heliotrope;
	mapSize = 0.6;
	scope = public;
