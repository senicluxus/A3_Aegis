...
class C_IDAP_Truck_02_cargo_F: Truck_02_cargo_base_F
{
	...
	editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\C_IDAP_Truck_02_cargo_F.jpg";
	scope = public;
	scopeCurator = public;
...
class C_IDAP_Truck_02_flatbed_F: Truck_02_flatbed_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
	...
	//editorPreview = "\A3_Aegis\EditorPreviews_F_Aegis\Data\CfgVehicles\C_IDAP_Truck_02_flatbed_F.jpg";
	scope = public;
	scopeCurator = public;
